...
CREATE TABLE `%TABLE_PREFIX%config` (
  ...
  `reply_separator` varchar(60) NOT NULL default ' -- não editar --',
  `admin_email` varchar(125) NOT NULL default '',
  `helpdesk_title` varchar(255) NOT NULL default 'Systema de suporte por tickets OsTicket',
...
(1, 0, 1, 0, 0, 'Suporte', 'Equipe de Suporte', 1, 1, 1, 1, NOW(), NOW()),
(2, 0, 1, 0, 0, 'Cobrança', 'Departamento Financeiro', 1, 1, 1, 1, NOW(), NOW());
...
INSERT INTO `%TABLE_PREFIX%email_template` (
	`tpl_id`, `cfg_id`, `name`, 
	`notes`,
...
(
	1, 1,
	'Template padrão para osTicket', 
	'Template padrão para osTicket', 
	'Ticket de Suporte Aberto [#%ticket]', 
	'%name,\r\n\r\nUma requisição de suporte foi criada e associada ao ticket: #%ticket. Um representante de nossa empresa irá entrar em contato assim que possível.\r\n\r\nVocê pode ver o progresso deste ticket no site: %url/tickets.php?e=%email&t=%ticket.\r\n\r\nSe você enviar comentários e informações adicionais referente a este chamado, por favor não abra um novo ticket. Simplesmente faça seu registro usando o link acima e atualise o ticket.\r\n\r\n%signature',
	'Alerta de novo Ticket', 
	'%staff,\r\n\r\nNovo ticket criado: #%ticket.\r\n-------------------\r\nNome: %name\r\nEmail: %email\r\nDept: %dept\r\n\r\n%message\r\n-------------------\r\n\r\nPara visualizar/responder o ticket, por favor faça o registro no sistema de ticket.\r\n\r\nAtenciosamente,\r\n\r\nSistema de suporte ao cliente, powered by osTicket.', 
	'[#%ticket] Mensagem adicionada',
	'%name,\r\n\r\nYour reply to support request #%ticket has been noted.\r\n\r\nYou can view this support request progress online here: %url/tickets.php?e=%email&t=%ticket.\r\n\r\n%signature', 'New Message Alert', 
...
(1, 0, 1, 'O que é osTicket (exemplo)?', 'osTicket é um sistema de suporte via ticket.', NOW(), NOW());
...
CREATE TABLE `%TABLE_PREFIX%ticket` (
  ...
  `name` varchar(32) NOT NULL default '',
  `subject` varchar(64) NOT NULL default '[sem assunto]',
...
CREATE TABLE `%TABLE_PREFIX%ticket_note` (
  ...
  `title` varchar(255) NOT NULL default 'Observações Gerais Internas',
  `note` text NOT NULL,
  `created` datetime NOT NULL default '0000-00-00 00:00:00',
  PRIMARY KEY  (`note_id`),
  KEY `ticket_id` (`ticket_id`),
